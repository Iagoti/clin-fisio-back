...
@Component
public class CancelarDespesaUseCase {
    ...
    public CancelarDespesaUseCase(IDespesaRepository despesaRepository, ICategoriaDespesaRepository categoriaDespesaRepository, DespesaMapper mapper) {
